...
use App\Policies\SupplyDeliveryPolicy;
use App\Policies\TenantPolicy;
use App\Policies\UnitPolicy;
use App\Policies\WorkOrderChildPolicy;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        Gate::policy(WorkOrderAssignment::class, WorkOrderChildPolicy::class);
        Gate::policy(ServiceAppointment::class, WorkOrderChildPolicy::class);
        Gate::policy(WorkOrderCompletionSubmission::class, WorkOrderChildPolicy::class);
        Gate::policy(WorkOrderEvidence::class, WorkOrderChildPolicy::class);
        Gate::policy(SupplyDelivery::class, SupplyDeliveryPolicy::class);
        Gate::policy(WorkOrderActivity::class, WorkOrderChildPolicy::class);
